  ...
  <main class="page"> 
   <section class="portfolio-block"> 
    <div class="container"> 
     ...
     <table id="table" data-cookie="true" data-cookie-id-table="betsTable" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-show-footer="true" data-side-pagination="server" data-url="/get-coinflips.php" data-response-handler="responseHandler"> 
     </table> 
    </div> 
   </section> 
  </main> 
